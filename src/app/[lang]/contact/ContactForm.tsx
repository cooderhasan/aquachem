    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setStatus('error');
                setErrorMessage(result.error || dict.contact.errorMessage);
            }
        } catch (error) {
            setStatus('error');
    ...
    return (
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">{dict.contact.subject}</label>
                ...
                <div className="flex justify-end">
                    ...
                    >
                        ...
                        {isLoading ? dict.contact.sending : dict.contact.send}
                    </button>
                </div>
            </form>
        </div>
